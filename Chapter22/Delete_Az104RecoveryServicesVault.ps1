...
$VaultName = "Az104RecoveryServicesVault" #fetch automatically
$Subscription = "" #fetch automatically
$ResourceGroup = "AZ104-BCDR" #fetch automatically
$SubscriptionId = "" #fetch automatically
